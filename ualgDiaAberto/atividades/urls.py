...
urlpatterns = [
    ...
    path('getLocal/<int:edificioid>/<int:atividadeid>', views.getLocal, name='getLocal'),
    path('getLocalExterior/<int:campusid>/<int:atividadeid>', views.getLocalExterior, name='getLocalExterior'),
